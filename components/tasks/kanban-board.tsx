    ...
    <div
      ...
      style={{
        ...
        background: isCardOver
          ? accentBgLight
          : `linear-gradient(180deg, color-mix(in srgb, ${accent} 10%, #ffffff) 0%, #ffffff 30%)`,
        border: `1px solid ${isCardOver ? accent : `color-mix(in srgb, ${accent} 32%, var(--color-hairline))`}`,
        opacity: isDragging ? 0.5 : 1,
        boxShadow: `0 20px 44px -26px color-mix(in srgb, ${accent} 65%, transparent), 0 2px 6px rgba(15,23,42,0.05)`,

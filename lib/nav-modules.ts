...
export const MODULES: ModuleDef[] = [
  ...
  },
  {
    ...
    tagline: "Your earnings, collections & references.",
    icon: "TrendingUp",
    landing: "/incentive",
    routes: ["/incentive", "/outstanding", "/record-reference", "/participant-breakthrough"],
    accent: { from: "#6366F1", to: "#3F3FB0", ink: "#4F46E5" },
    items: [
      { href: "/incentive", label: "My Incentives", icon: "Award", notMatch: ["/incentive/admin"] },
      { href: "/incentive/admin", label: "Admin", icon: "SlidersHorizontal", adminOnly: true },
